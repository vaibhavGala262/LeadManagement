  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-red-600 text-white hover:bg-red-500 shadow-sm dark:bg-red-700 dark:hover:bg-red-600",
        outline:
        ...
        secondary:
          "bg-zinc-100 text-zinc-900 hover:bg-zinc-200 shadow-sm dark:bg-zinc-800 dark:text-zinc-50 dark:hover:bg-zinc-700",
        ghost:
